...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    $sql = "SELECT * FROM studentaccount WHERE username = ?";
    ...
    if($errormsg == 1) {
        ...
        try{
            $sql = "INSERT INTO studentaccount (firstname, lastname, username, email, password) VALUES (:firstname, :lastname, :username, :email, :password) ";
...
{
    ?>
    <form name="createstudent" id="createstudent" method="post" action="createstudent.php">
        <table class="center">
